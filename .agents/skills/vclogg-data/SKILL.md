...
- `state_repository.rs`: SQLite access for recent files, pinning, history protection/deletion, workspace recovery, revision-aware session conflict merging, UI values, search preferences/history, filter/color records and database statistics.
