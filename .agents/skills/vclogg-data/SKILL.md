...
- `crates/vclogg-app/src/state_store.rs`: transitional SQLite implementation being migrated behind data DTO adapters; do not add new persistence responsibilities there.
